# -*- coding: utf-8 -*-
#
# FluxFingers Scoreboard documentation build configuration file, created by
# sphinx-quickstart on Tue Aug  6 22:44:36 2013.
#
...
project = u'FluxFingers Scoreboard'
...
htmlhelp_basename = 'FluxFingersScoreboarddoc'
...
latex_documents = [
  ('index', 'FluxFingersScoreboard.tex', u'FluxFingers Scoreboard Documentation',
...
man_pages = [
    ('index', 'fluxfingersscoreboard', u'FluxFingers Scoreboard Documentation',
     [u'Florian Rüchel'], 1)
]
...
texinfo_documents = [
  ('index', 'FluxFingersScoreboard', u'FluxFingers Scoreboard Documentation',
   u'Florian Rüchel', 'FluxFingersScoreboard', 'One line description of project.',
   'Miscellaneous'),
]
