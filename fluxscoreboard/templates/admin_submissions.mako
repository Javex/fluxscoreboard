            ...
            <tr>
                ...
                <td class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${request.route_url('admin_submissions_edit', cid=submission.challenge_id, tid=submission.team_id)}">Edit</a></li>
                        <li><a href="${request.route_url('admin_submissions_delete', cid=submission.challenge_id, tid=submission.team_id)}">Delete</a></li>
                    </ul>
                </td>
            </tr>
    % endfor
...
${admin_funcs.display_admin_form('admin_submissions', form, "Submission", is_new)}
